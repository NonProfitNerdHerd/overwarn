...
export default function LayoutOverlay2() {
  ...
  const showSummaryCounts =
    filteredRegionCounts.severe > 0 || filteredRegionCounts.tornado > 0;
  ...
  return (
    ...
    >
      ...
      <div
        className={`grid grid-cols-[auto_1fr] grid-rows-2 w-full min-h-[90px]${hasActiveAlert ? " border-t border-neutral-700" : ""}`}
      >
        <AlertTypeBar
